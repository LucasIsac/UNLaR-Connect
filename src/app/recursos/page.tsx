                  ...
                  {paginatedResources.map((rsc) => {
                    return (
                      <motion.div
                        ...
                        className="bg-glass rounded-2xl p-10 flex flex-col hover:-translate-y-1 transition-all duration-300 group cursor-pointer hover:shadow-[0_0_20px_rgba(var(--accent-rgb),0.1)] relative border border-primary/5 hover:border-accent/30 overflow-hidden"
                      >
