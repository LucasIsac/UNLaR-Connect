...
export default function DashboardError({ error, reset }: DashboardErrorProps) {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-lg bg-card rounded-3xl border border-destructive/20 p-8 text-center shadow-2xl">
        ...
        <h1 className="font-heading text-2xl font-black text-foreground mb-2">
        ...
        {error.message && (
          <p className="text-[11px] text-muted-foreground/80 bg-muted border border-border rounded-xl p-3 mb-6 font-mono break-words">
            {error.message}
          </p>
        )}
