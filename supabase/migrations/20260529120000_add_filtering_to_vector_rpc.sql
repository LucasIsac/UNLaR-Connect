-- Migration: Add Filtering to Vector RPC for RAG Context Selection
-- Target: Redeploy public.buscar_apuntes RPC function with subject, topic, and type filtering options
...
-- Grant permissions (standard best practices)
